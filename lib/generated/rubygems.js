...
/* Generated by Opal 0.10.2 */
Opal.modules["rubygems-js-compat/version"] = function(Opal) {
  function $rb_gt(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs > rhs : lhs['$>'](rhs);
  }
  function $rb_lt(lhs, rhs) {
  ...
  Opal.add_stubs(['$include', '$dup', '$=~', '$to_s', '$===', '$nil?', '$new', '$==', '$[]', '$[]=', '$correct?', '$class', '$raise', '$gsub', '$strip', '$segments', '$any?', '$pop', '$>', '$size', '$succ', '$join', '$_version', '$hash', '$yaml_initialize', '$tag', '$map', '$inspect', '$version', '$initialize', '$add', '$!', '$text', '$prerelease?', '$to_i', '$scan', '$<', '$push', '$-', '$<=', '$+', '$<=>', '$protected']);
  return (function($base, $super) {
    function $GemVersion(){};
    var self = $GemVersion = $klass($base, $super, 'GemVersion', $GemVersion);

    var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2, TMP_3, TMP_4, TMP_5, TMP_7, TMP_8, TMP_9, TMP_10, TMP_11, TMP_12, TMP_13, TMP_14, TMP_15, TMP_16, TMP_17, TMP_18, TMP_20, TMP_22, TMP_24, TMP_25, TMP_26;

    def.version = def.bump = def.prerelease = def.release = def.segments = nil;
    self.$include($scope.get('Comparable'));

    Opal.cdecl($scope, 'VERSION_PATTERN', "[0-9]+(\\.[0-9a-zA-Z]+)*(-[0-9A-Za-z-]+(\\.[0-9A-Za-z-]+)*)?");

    Opal.cdecl($scope, 'ANCHORED_VERSION_PATTERN', (new RegExp("^\\s*(" + (($scope.get('GemVersion')).$$scope.get('VERSION_PATTERN')) + ")?\\s*$")));

    Opal.defn(self, '$version', TMP_1 = function ːversion() {
      var self = this;

      return self.version.$dup();
    }, TMP_1.$$arity = 0);

    Opal.alias(self, 'to_s', 'version');

    Opal.defs(self, '$correct?', TMP_2 = function(version) {
      var self = this;

      return version.$to_s()['$=~']($scope.get('ANCHORED_VERSION_PATTERN'));
    }, TMP_2.$$arity = 1);

    Opal.defs(self, '$create', TMP_3 = function ːcreate(input) {
      var $a, self = this;

      if ((($a = self['$==='](input)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return input
      } else if ((($a = input['$nil?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return nil
        } else {
    ...
    (Opal.cvars['@@all'] = $hash2([], {}));

    Opal.defs(self, '$new', TMP_4 = function(version) {
      var $a, $b, $c, $d, $e, $f, self = this, $iter = TMP_4.$$p, $yield = $iter || nil, $zuper = nil, $zuper_index = nil, $zuper_length = nil;
      ...
      if ($scope.get('GemVersion')['$=='](self)) {
        } else {
        return ($a = ($b = self, Opal.find_super_dispatcher(self, 'new', TMP_4, false, $GemVersion)), $a.$$p = $iter, $a).apply($b, $zuper)
      };
      return ($a = version, $c = (($d = Opal.cvars['@@all']) == null ? nil : $d), ((($d = $c['$[]']($a)) !== false && $d !== nil && $d != null) ? $d : $c['$[]=']($a, ($e = ($f = self, Opal.find_super_dispatcher(self, 'new', TMP_4, false, $GemVersion)), $e.$$p = $iter, $e).apply($f, $zuper))));
    }, TMP_4.$$arity = 1);

    Opal.defn(self, '$initialize', TMP_5 = function ːinitialize(version) {
      var $a, self = this;

      if ((($a = self.$class()['$correct?'](version)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        self.$raise($scope.get('ArgumentError'), "Malformed version number string " + (version))
      };
      self.version = version.$to_s().$strip().$gsub("-", ".pre.");
      return self.segments = nil;
    }, TMP_5.$$arity = 1);

    Opal.defn(self, '$bump', TMP_7 = function ːbump() {
      var $a, $b, $c, $d, $e, TMP_6, self = this, segments = nil;

      return ((($a = self.bump) !== false && $a !== nil && $a != null) ? $a : self.bump = (function() {segments = self.$segments().$dup();
      while ((($c = ($d = ($e = segments)['$any?'], $d.$$p = (TMP_6 = function(s){var self = TMP_6.$$s || this;
if (s == null) s = nil;
      return $scope.get('String')['$==='](s)}, TMP_6.$$s = self, TMP_6.$$arity = 1, TMP_6), $d).call($e)) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
      segments.$pop()};
      if ((($b = $rb_gt(segments.$size(), 1)) !== nil && $b != null && (!$b.$$is_boolean || $b == true))) {
        segments.$pop()};
      segments['$[]='](-1, segments['$[]'](-1).$succ());
      return self.$class().$new(segments.$join("."));})());
    }, TMP_7.$$arity = 0);

    Opal.defn(self, '$eql?', TMP_8 = function(other) {
      var $a, self = this;

      return ($a = self.$class()['$==='](other), $a !== false && $a !== nil && $a != null ?self.version['$=='](other.$_version()) : $a);
    }, TMP_8.$$arity = 1);

    Opal.defn(self, '$hash', TMP_9 = function ːhash() {
      var self = this;

      return self.version.$hash();
    }, TMP_9.$$arity = 0);

    Opal.defn(self, '$init_with', TMP_10 = function ːinit_with(coder) {
      var self = this;

      return self.$yaml_initialize(coder.$tag(), coder.$map());
    }, TMP_10.$$arity = 1);

    Opal.defn(self, '$inspect', TMP_11 = function ːinspect() {
      var self = this;

      return "#<" + (self.$class()) + " " + (self.$version().$inspect()) + ">";
    }, TMP_11.$$arity = 0);

    Opal.defn(self, '$marshal_dump', TMP_12 = function ːmarshal_dump() {
      var self = this;

      return [self.$version()];
    }, TMP_12.$$arity = 0);

    Opal.defn(self, '$marshal_load', TMP_13 = function ːmarshal_load(array) {
      var self = this;

      return self.$initialize(array['$[]'](0));
    }, TMP_13.$$arity = 1);

    Opal.defn(self, '$yaml_initialize', TMP_14 = function ːyaml_initialize(tag, map) {
      var self = this;
    ...
    Opal.defn(self, '$to_yaml_properties', TMP_15 = function ːto_yaml_properties() {
      var self = this;

      return ["@version"];
    }, TMP_15.$$arity = 0);

    Opal.defn(self, '$encode_with', TMP_16 = function ːencode_with(coder) {
      var self = this;

      return coder.$add("version", self.version);
    }, TMP_16.$$arity = 1);

    Opal.defn(self, '$prerelease?', TMP_17 = function() {
      var $a, self = this;

      return ((($a = self.prerelease) !== false && $a !== nil && $a != null) ? $a : self.prerelease = (self.version['$=~'](/[a-zA-Z]/))['$!']()['$!']());
    }, TMP_17.$$arity = 0);

    Opal.defn(self, '$pretty_print', TMP_18 = function ːpretty_print(q) {
      var self = this;

      return q.$text("GemVersion.new(" + (self.$version().$inspect()) + ")");
    }, TMP_18.$$arity = 1);

    Opal.defn(self, '$release', TMP_20 = function ːrelease() {
      var $a, $b, $c, $d, $e, TMP_19, self = this, segments = nil;

      return ((($a = self.release) !== false && $a !== nil && $a != null) ? $a : self.release = (function() {if ((($b = self['$prerelease?']()) !== nil && $b != null && (!$b.$$is_boolean || $b == true))) {
        segments = self.$segments().$dup();
        while ((($c = ($d = ($e = segments)['$any?'], $d.$$p = (TMP_19 = function(s){var self = TMP_19.$$s || this;
if (s == null) s = nil;
        return $scope.get('String')['$==='](s)}, TMP_19.$$s = self, TMP_19.$$arity = 1, TMP_19), $d).call($e)) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
        segments.$pop()};
        return self.$class().$new(segments.$join("."));
        } else {
        return self
    ...
    Opal.defn(self, '$segments', TMP_22 = function ːsegments() {
      var $a, $b, $c, TMP_21, self = this;

      return ((($a = self.segments) !== false && $a !== nil && $a != null) ? $a : self.segments = ($b = ($c = self.version.$scan(/[0-9]+|[a-z]+/i)).$map, $b.$$p = (TMP_21 = function(s){var self = TMP_21.$$s || this, $d;
if (s == null) s = nil;
      if ((($d = /^\d+$/['$=~'](s)) !== nil && $d != null && (!$d.$$is_boolean || $d == true))) {
          return s.$to_i()
          } else {
          return s
        }}, TMP_21.$$s = self, TMP_21.$$arity = 1, TMP_21), $b).call($c));
    }, TMP_22.$$arity = 0);

    Opal.defn(self, '$approximate_recommendation', TMP_24 = function ːapproximate_recommendation() {
      var $a, $b, $c, $d, TMP_23, self = this, segments = nil;

      segments = self.$segments().$dup();
      while ((($b = ($c = ($d = segments)['$any?'], $c.$$p = (TMP_23 = function(s){var self = TMP_23.$$s || this;
if (s == null) s = nil;
      return $scope.get('String')['$==='](s)}, TMP_23.$$s = self, TMP_23.$$arity = 1, TMP_23), $c).call($d)) !== nil && $b != null && (!$b.$$is_boolean || $b == true))) {
      segments.$pop()};
      while ((($b = $rb_gt(segments.$size(), 2)) !== nil && $b != null && (!$b.$$is_boolean || $b == true))) {
      segments.$pop()};
      while ((($b = $rb_lt(segments.$size(), 2)) !== nil && $b != null && (!$b.$$is_boolean || $b == true))) {
      segments.$push(0)};
      return "~> " + (segments.$join("."));
    }, TMP_24.$$arity = 0);

    Opal.defn(self, '$<=>', TMP_25 = function(other) {
      var $a, $b, $c, self = this, lhsegments = nil, rhsegments = nil, lhsize = nil, rhsize = nil, limit = nil, i = nil, lhs = nil, rhs = nil;

      if ((($a = $scope.get('GemVersion')['$==='](other)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        return nil
      };
      if (self.version['$=='](other.$_version())) {
        return 0};
      lhsegments = self.$segments();
      rhsegments = other.$segments();
      lhsize = lhsegments.$size();
      rhsize = rhsegments.$size();
      limit = $rb_minus(((function() {if ((($a = $rb_gt(lhsize, rhsize)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return lhsize
        } else {
        return rhsize
      }; return nil; })()), 1);
      i = 0;
      while ((($b = $rb_le(i, limit)) !== nil && $b != null && (!$b.$$is_boolean || $b == true))) {
      $b = [((($c = lhsegments['$[]'](i)) !== false && $c !== nil && $c != null) ? $c : 0), ((($c = rhsegments['$[]'](i)) !== false && $c !== nil && $c != null) ? $c : 0)], lhs = $b[0], rhs = $b[1], $b;
      i = $rb_plus(i, 1);
      if (lhs['$=='](rhs)) {
        continue;};
      if ((($b = ($c = $scope.get('String')['$==='](lhs), $c !== false && $c !== nil && $c != null ?$scope.get('Numeric')['$==='](rhs) : $c)) !== nil && $b != null && (!$b.$$is_boolean || $b == true))) {
        return -1};
      if ((($b = ($c = $scope.get('Numeric')['$==='](lhs), $c !== false && $c !== nil && $c != null ?$scope.get('String')['$==='](rhs) : $c)) !== nil && $b != null && (!$b.$$is_boolean || $b == true))) {
        return 1};
      return lhs['$<=>'](rhs);};
      return 0;
    }, TMP_25.$$arity = 1);
    ...
    return (Opal.defn(self, '$_version', TMP_26 = function ː_version() {
      var self = this;

      return self.version;
    }, TMP_26.$$arity = 0), nil) && '_version';
  })($scope.base, null)
};

/* Generated by Opal 0.10.2 */
Opal.modules["rubygems-js-compat/requirement"] = function(Opal) {
  function $rb_gt(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs > rhs : lhs['$>'](rhs);
  }
  function $rb_lt(lhs, rhs) {
  ...
  Opal.add_stubs(['$lambda', '$==', '$!=', '$>', '$<', '$>=', '$<=', '$release', '$bump', '$new', '$join', '$map', '$quote', '$keys', '$===', '$source_set', '$respond_to?', '$to_str', '$default', '$=~', '$to_s', '$raise', '$inspect', '$attr_reader', '$flatten', '$compact!', '$uniq!', '$empty?', '$map!', '$parse', '$class', '$concat', '$uniq', '$sort_by', '$requirements', '$size', '$[]', '$sort', '$hash', '$fix_syck_default_key_in_requirements', '$each', '$instance_variable_set', '$load_yaml', '$yaml_initialize', '$tag', '$add', '$any?', '$prerelease?', '$last', '$group', '$pp', '$as_list', '$all?', '$call', '$length', '$!', '$include?', '$first', '$private', '$kind_of?', '$[]=']);
  self.$require("rubygems-js-compat/requirement"+ '/../' + "./version");
  (function($base, $super) {
    function $GemRequirement(){};
    var self = $GemRequirement = $klass($base, $super, 'GemRequirement', $GemRequirement);

    var def = self.$$proto, $scope = self.$$scope, $a, $b, TMP_1, $c, TMP_2, $d, TMP_3, $e, TMP_4, $f, TMP_5, $g, TMP_6, $h, TMP_7, $i, TMP_8, TMP_9, TMP_10, TMP_11, TMP_12, TMP_14, TMP_16, TMP_19, TMP_20, TMP_21, TMP_23, TMP_24, TMP_25, TMP_26, TMP_28, TMP_29, TMP_30, TMP_31, TMP_33, TMP_35, TMP_37, TMP_38, TMP_39, TMP_40, TMP_42, quoted = nil;

    def.requirements = nil;
    Opal.cdecl($scope, 'OPS', $hash2(["=", "!=", ">", "<", ">=", "<=", "~>"], {"=": ($a = ($b = self).$lambda, $a.$$p = (TMP_1 = function(v, r){var self = TMP_1.$$s || this;
if (v == null) v = nil;if (r == null) r = nil;
    return v['$=='](r)}, TMP_1.$$s = self, TMP_1.$$arity = 2, TMP_1), $a).call($b), "!=": ($a = ($c = self).$lambda, $a.$$p = (TMP_2 = function(v, r){var self = TMP_2.$$s || this;
if (v == null) v = nil;if (r == null) r = nil;
    return v['$!='](r)}, TMP_2.$$s = self, TMP_2.$$arity = 2, TMP_2), $a).call($c), ">": ($a = ($d = self).$lambda, $a.$$p = (TMP_3 = function(v, r){var self = TMP_3.$$s || this;
if (v == null) v = nil;if (r == null) r = nil;
    return $rb_gt(v, r)}, TMP_3.$$s = self, TMP_3.$$arity = 2, TMP_3), $a).call($d), "<": ($a = ($e = self).$lambda, $a.$$p = (TMP_4 = function(v, r){var self = TMP_4.$$s || this;
if (v == null) v = nil;if (r == null) r = nil;
    return $rb_lt(v, r)}, TMP_4.$$s = self, TMP_4.$$arity = 2, TMP_4), $a).call($e), ">=": ($a = ($f = self).$lambda, $a.$$p = (TMP_5 = function(v, r){var self = TMP_5.$$s || this;
if (v == null) v = nil;if (r == null) r = nil;
    return $rb_ge(v, r)}, TMP_5.$$s = self, TMP_5.$$arity = 2, TMP_5), $a).call($f), "<=": ($a = ($g = self).$lambda, $a.$$p = (TMP_6 = function(v, r){var self = TMP_6.$$s || this;
if (v == null) v = nil;if (r == null) r = nil;
    return $rb_le(v, r)}, TMP_6.$$s = self, TMP_6.$$arity = 2, TMP_6), $a).call($g), "~>": ($a = ($h = self).$lambda, $a.$$p = (TMP_7 = function(v, r){var self = TMP_7.$$s || this, $i;
if (v == null) v = nil;if (r == null) r = nil;
    return ($i = $rb_ge(v, r), $i !== false && $i !== nil && $i != null ?$rb_lt(v.$release(), r.$bump()) : $i)}, TMP_7.$$s = self, TMP_7.$$arity = 2, TMP_7), $a).call($h)}));

    Opal.cdecl($scope, 'SOURCE_SET_REQUIREMENT', $scope.get('Struct').$new("for_lockfile").$new("!"));

    quoted = ($a = ($i = $scope.get('OPS').$keys()).$map, $a.$$p = (TMP_8 = function(k){var self = TMP_8.$$s || this;
if (k == null) k = nil;
    return $scope.get('Regexp').$quote(k)}, TMP_8.$$s = self, TMP_8.$$arity = 1, TMP_8), $a).call($i).$join("|");

    Opal.cdecl($scope, 'PATTERN_RAW', "\\s*(" + (quoted) + ")?\\s*(" + ((($scope.get('GemVersion')).$$scope.get('VERSION_PATTERN'))) + ")\\s*");

    Opal.cdecl($scope, 'PATTERN', (new RegExp("^" + $scope.get('PATTERN_RAW') + "$")));

    Opal.cdecl($scope, 'DefaultRequirement', [">=", $scope.get('GemVersion').$new(0)]);

    (function($base, $super) {
      function $BadRequirementError(){};
      var self = $BadRequirementError = $klass($base, $super, 'BadRequirementError', $BadRequirementError);
    ...
    Opal.defs(self, '$create', TMP_9 = function ːcreate(input) {
      var $a, self = this, $case = nil;

      return (function() {$case = input;if ($scope.get('GemRequirement')['$===']($case)) {return input}else if ($scope.get('GemVersion')['$===']($case) || $scope.get('Array')['$===']($case)) {return self.$new(input)}else if ("!"['$===']($case)) {return self.$source_set()}else {if ((($a = input['$respond_to?']("to_str")) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
    ...
    Opal.defs(self, '$default', TMP_10 = function() {
      var self = this;

      return self.$new(">= 0");
    }, TMP_10.$$arity = 0);

    Opal.defs(self, '$source_set', TMP_11 = function ːsource_set() {
      var self = this;

      return $scope.get('SOURCE_SET_REQUIREMENT');
    }, TMP_11.$$arity = 0);

    Opal.defs(self, '$parse', TMP_12 = function ːparse(obj) {
      var $a, $b, $c, self = this;

      if ((($a = $scope.get('GemVersion')['$==='](obj)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return ["=", obj]};
      if ((($a = $scope.get('PATTERN')['$=~'](obj.$to_s())) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        self.$raise($scope.get('BadRequirementError'), "Illformed requirement [" + (obj.$inspect()) + "]")
      };
      if ((($a = (($b = (($c = $gvars['~']) === nil ? nil : $c['$[]'](1))['$=='](">=")) ? (($c = $gvars['~']) === nil ? nil : $c['$[]'](2))['$==']("0") : (($c = $gvars['~']) === nil ? nil : $c['$[]'](1))['$=='](">="))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return $scope.get('DefaultRequirement')
        } else {
        return [((($a = (($b = $gvars['~']) === nil ? nil : $b['$[]'](1))) !== false && $a !== nil && $a != null) ? $a : "="), $scope.get('GemVersion').$new((($a = $gvars['~']) === nil ? nil : $a['$[]'](2)))]
      };
    }, TMP_12.$$arity = 1);

    self.$attr_reader("requirements");

    Opal.defn(self, '$initialize', TMP_14 = function ːinitialize($a_rest) {
      var $b, $c, TMP_13, self = this, requirements;

      var $args_len = arguments.length, $rest_len = $args_len - 0;
      if ($rest_len < 0) { $rest_len = 0; }
      requirements = new Array($rest_len);
      for (var $arg_idx = 0; $arg_idx < $args_len; $arg_idx++) {
        requirements[$arg_idx - 0] = arguments[$arg_idx];
      }
      requirements = requirements.$flatten();
      requirements['$compact!']();
      requirements['$uniq!']();
      if ((($b = requirements['$empty?']()) !== nil && $b != null && (!$b.$$is_boolean || $b == true))) {
        return self.requirements = [$scope.get('DefaultRequirement')]
        } else {
        return self.requirements = ($b = ($c = requirements)['$map!'], $b.$$p = (TMP_13 = function(r){var self = TMP_13.$$s || this;
if (r == null) r = nil;
        return self.$class().$parse(r)}, TMP_13.$$s = self, TMP_13.$$arity = 1, TMP_13), $b).call($c)
      };
    }, TMP_14.$$arity = -1);

    Opal.defn(self, '$concat', TMP_16 = function ːconcat(new$) {
      var $a, $b, TMP_15, self = this, new$ = nil;

      new$ = new$.$flatten();
      new$['$compact!']();
      new$['$uniq!']();
      new$ = ($a = ($b = new$).$map, $a.$$p = (TMP_15 = function(r){var self = TMP_15.$$s || this;
if (r == null) r = nil;
      return self.$class().$parse(r)}, TMP_15.$$s = self, TMP_15.$$arity = 1, TMP_15), $a).call($b);
      return self.requirements.$concat(new$);
    }, TMP_16.$$arity = 1);

    Opal.defn(self, '$for_lockfile', TMP_19 = function ːfor_lockfile() {
      var $a, $b, TMP_17, $c, $d, TMP_18, self = this, list = nil;

      if ([$scope.get('DefaultRequirement')]['$=='](self.requirements)) {
        return nil};
      list = ($a = ($b = ($c = ($d = self.$requirements()).$sort_by, $c.$$p = (TMP_18 = function(_, version){var self = TMP_18.$$s || this;
if (_ == null) _ = nil;if (version == null) version = nil;
      return version}, TMP_18.$$s = self, TMP_18.$$arity = 2, TMP_18), $c).call($d)).$map, $a.$$p = (TMP_17 = function(op, version){var self = TMP_17.$$s || this;
if (op == null) op = nil;if (version == null) version = nil;
      return "" + (op) + " " + (version)}, TMP_17.$$s = self, TMP_17.$$arity = 2, TMP_17), $a).call($b).$uniq();
      return " (" + (list.$join(", ")) + ")";
    }, TMP_19.$$arity = 0);

    Opal.defn(self, '$none?', TMP_20 = function() {
      var self = this;

      if (self.requirements.$size()['$=='](1)) {
        return self.requirements['$[]'](0)['$==']($scope.get('DefaultRequirement'))
        } else {
        return false
      };
    }, TMP_20.$$arity = 0);

    Opal.defn(self, '$exact?', TMP_21 = function() {
      var self = this;
    ...
    Opal.defn(self, '$as_list', TMP_23 = function ːas_list() {
      var $a, $b, TMP_22, self = this;

      return ($a = ($b = self.$requirements()).$map, $a.$$p = (TMP_22 = function(op, version){var self = TMP_22.$$s || this;
if (op == null) op = nil;if (version == null) version = nil;
      return "" + (op) + " " + (version)}, TMP_22.$$s = self, TMP_22.$$arity = 2, TMP_22), $a).call($b).$sort();
    }, TMP_23.$$arity = 0);

    Opal.defn(self, '$hash', TMP_24 = function ːhash() {
      var self = this;

      return self.$requirements().$sort().$hash();
    }, TMP_24.$$arity = 0);

    Opal.defn(self, '$marshal_dump', TMP_25 = function ːmarshal_dump() {
      var self = this;

      self.$fix_syck_default_key_in_requirements();
      return [self.requirements];
    }, TMP_25.$$arity = 0);

    Opal.defn(self, '$marshal_load', TMP_26 = function ːmarshal_load(array) {
      var self = this;

      self.requirements = array['$[]'](0);
      return self.$fix_syck_default_key_in_requirements();
    }, TMP_26.$$arity = 1);

    Opal.defn(self, '$yaml_initialize', TMP_28 = function ːyaml_initialize(tag, vals) {
      var $a, $b, TMP_27, self = this;

      ($a = ($b = vals).$each, $a.$$p = (TMP_27 = function(ivar, val){var self = TMP_27.$$s || this;
if (ivar == null) ivar = nil;if (val == null) val = nil;
      return self.$instance_variable_set("@" + (ivar), val)}, TMP_27.$$s = self, TMP_27.$$arity = 2, TMP_27), $a).call($b);
      $scope.get('Gem').$load_yaml();
      return self.$fix_syck_default_key_in_requirements();
    }, TMP_28.$$arity = 2);

    Opal.defn(self, '$init_with', TMP_29 = function ːinit_with(coder) {
      var self = this;

      return self.$yaml_initialize(coder.$tag(), coder.$map());
    }, TMP_29.$$arity = 1);

    Opal.defn(self, '$to_yaml_properties', TMP_30 = function ːto_yaml_properties() {
      var self = this;

      return ["@requirements"];
    }, TMP_30.$$arity = 0);

    Opal.defn(self, '$encode_with', TMP_31 = function ːencode_with(coder) {
      var self = this;

      return coder.$add("requirements", self.requirements);
    }, TMP_31.$$arity = 1);

    Opal.defn(self, '$prerelease?', TMP_33 = function() {
      var $a, $b, TMP_32, self = this;

      return ($a = ($b = self.$requirements())['$any?'], $a.$$p = (TMP_32 = function(r){var self = TMP_32.$$s || this;
if (r == null) r = nil;
      return r.$last()['$prerelease?']()}, TMP_32.$$s = self, TMP_32.$$arity = 1, TMP_32), $a).call($b);
    }, TMP_33.$$arity = 0);

    Opal.defn(self, '$pretty_print', TMP_35 = function ːpretty_print(q) {
      var $a, $b, TMP_34, self = this;

      return ($a = ($b = q).$group, $a.$$p = (TMP_34 = function(){var self = TMP_34.$$s || this;

      return q.$pp(self.$as_list())}, TMP_34.$$s = self, TMP_34.$$arity = 0, TMP_34), $a).call($b, 1, "GemRequirement.new(", ")");
    }, TMP_35.$$arity = 1);

    Opal.defn(self, '$satisfied_by?', TMP_37 = function(version) {
      var $a, $b, TMP_36, self = this;

      if ((($a = $scope.get('GemVersion')['$==='](version)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        } else {
        self.$raise($scope.get('ArgumentError'), "Need a GemVersion: " + (version.$inspect()))
      };
      return ($a = ($b = self.$requirements())['$all?'], $a.$$p = (TMP_36 = function(op, rv){var self = TMP_36.$$s || this, $c;
if (op == null) op = nil;if (rv == null) rv = nil;
      return (((($c = $scope.get('OPS')['$[]'](op)) !== false && $c !== nil && $c != null) ? $c : $scope.get('OPS')['$[]']("="))).$call(version, rv)}, TMP_36.$$s = self, TMP_36.$$arity = 2, TMP_36), $a).call($b);
    }, TMP_37.$$arity = 1);

    Opal.alias(self, '===', 'satisfied_by?');

    Opal.alias(self, '=~', 'satisfied_by?');

    Opal.defn(self, '$specific?', TMP_38 = function() {
      var $a, self = this;

      if ((($a = $rb_gt(self.requirements.$length(), 1)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return true};
      return [">", ">="]['$include?'](self.requirements.$first().$first())['$!']();
    }, TMP_38.$$arity = 0);

    Opal.defn(self, '$to_s', TMP_39 = function ːto_s() {
      var self = this;

      return self.$as_list().$join(", ");
    }, TMP_39.$$arity = 0);

    Opal.defn(self, '$==', TMP_40 = function(other) {
      var $a, self = this;

      return ($a = $scope.get('GemRequirement')['$==='](other), $a !== false && $a !== nil && $a != null ?self.$to_s()['$=='](other.$to_s()) : $a);
    }, TMP_40.$$arity = 1);

    self.$private();

    return (Opal.defn(self, '$fix_syck_default_key_in_requirements', TMP_42 = function ːfix_syck_default_key_in_requirements() {
      var $a, $b, TMP_41, self = this;

      $scope.get('Gem').$load_yaml();
      return ($a = ($b = self.requirements).$each, $a.$$p = (TMP_41 = function(r){var self = TMP_41.$$s || this, $c;
if (r == null) r = nil;
      if ((($c = r['$[]'](0)['$kind_of?']($scope.get('GemSyckDefaultKey'))) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
          return r['$[]='](0, "=")
          } else {
          return nil
        }}, TMP_41.$$s = self, TMP_41.$$arity = 1, TMP_41), $a).call($b);
    }, TMP_42.$$arity = 0), nil) && 'fix_syck_default_key_in_requirements';
  })($scope.base, null);
  return (function($base, $super) {
    function $GemVersion(){};
    var self = $GemVersion = $klass($base, $super, 'GemVersion', $GemVersion);
    ...
    return Opal.cdecl($scope, 'Requirement', $scope.get('GemRequirement'))
  })($scope.base, null);
};
...
(function(Opal) {
  ...
  Opal.add_stubs(['$require']);
  self.$require("opal");
  self.$require("rubygems-js-compat/version");
  return self.$require("rubygems-js-compat/requirement");
})(Opal);
