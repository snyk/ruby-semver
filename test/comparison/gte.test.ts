...
describe('test gte', () => {
  it('gte(v1, v2): v1 >= v2', () => {
    ...
    expect(gte('5.0.1-x86_64-linux', '5.0.1')).toBeTruthy();
    expect(gte('5.0.1', '5.0.1-x86_64-linux')).toBeTruthy();
    expect(gte('5.0.1-java', '5.0.1-x86_64-linux')).toBeTruthy();
    expect(gte('5.0.1-x86_64-linux', '5.0.1.beta')).toBeTruthy();
