...
describe('test minSatisfying', () => {
  ...
  it('minSatisfying(versions, range) multi-platform', () => {
    expect(
      minSatisfying(
        ['1.2.3-x86_64-linux', '1.2.4-x86_64-linux'],
        '~> 1.2-x86_64-linux',
      ),
    ).toBe('1.2.3-x86_64-linux');
    expect(
      minSatisfying(
        ['1.2.4-x86_64-linux', '1.2.3-x86_64-linux'],
        '~> 1.2-x86_64-linux',
      ),
    ).toBe('1.2.3-x86_64-linux');
    expect(
      minSatisfying(
        ['1.2.3-x86_64-linux', '1.2.4-x86_64-linux', '1.2.5-x86_64-linux'],
        '~> 1.2-x86_64-linux, >= 1.2.4-x86_64-linux',
      ),
    ).toBe('1.2.4-x86_64-linux');
    expect(
      minSatisfying(
        [
          '1.2.3-x86_64-linux',
    ...
    expect(
      minSatisfying(
        [
          ...
          '1.2.1-x86_64-linux',
          '1.3.0-x86_64-linux',
          '2.0.0b1-x86_64-linux',
          '2.0.0b2-x86_64-linux',
          '2.0.0b3-x86_64-linux',
          '2.0.0-x86_64-linux',
          '2.1.0-x86_64-linux',
        ],
        '~> 2.0.0-x86_64-linux',
      ),
    ).toBe('2.0.0-x86_64-linux');
    expect(
      minSatisfying(
        ['1.2.3-x86_64-linux', '1.2.4-x86_64-linux'],
        '> 3.2-x86_64-linux',
